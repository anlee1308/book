            ...
            <Row className="mt-5">
                ...
                <Col sm={12} md={6}>
                    <div className="p-3">
                        ...
                        <i className="fas fa-map-marker-alt"></i> <i> VietNam </i><br /> <br />
                        <i className="fas fa-envelope"></i> <i> nhom8@gmail.com </i> <br /> <br />
                        <i className="fas fa-phone"></i> <i>Call Us: 0123456789</i>  <br /> <br />
                        <Form className="mt-3">
                            <Form.Row>
